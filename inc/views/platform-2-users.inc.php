...
if (isset($_GET['delete'])) {
    ...
    $qDelete = $pfCon->query("DELETE FROM users WHERE id=$user");
}

$qUsers = $pfCon->query("SELECT * FROM users WHERE 1 $completion GROUP BY email ORDER BY id DESC");
        ...
        <table class="striped small">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="?view=platform_2_users&delete=<?= $user['id'] ?>" class="red" style="padding:3px 10px;color:white;border-radius:3px;">Excluir</a>
